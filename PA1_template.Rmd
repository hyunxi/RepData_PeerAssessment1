...
```
- Mean total number of steps/day : `r mean`
- Median steps/day : `r median`
...
```
- `r max[1,1]` interval contains the maximum number of `r max[1,2]` steps 
...
```
- There are `r missing` rows with NAs.
...
```
- Imputed Mean :`r imputed_mean` vs Original Mean `r mean`
- Imputed Median :`r imputed_median` vs Original Median `r median`
